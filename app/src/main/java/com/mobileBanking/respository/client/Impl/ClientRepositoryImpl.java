...
import com.mobileBanking.respository.client.ClientRepository;
 ...
 */
public abstract class ClientRepositoryImpl extends SQLiteOpenHelper implements ClientRepository {
    public static final String TABLE_NAME = "person";
    private SQLiteDatabase db;

    public static final String COLUMN_ID = "id";
    public static final String COLUMN_FIRSTNAME = "firstName";
    public static final String COLUMN_PASSWORD = "emailAddress";
